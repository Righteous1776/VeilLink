...
checks = {
    ...
    'VeilLink/UI/ToolCenterView.swift': ['VeilToolCenterView', 'VeilWalkieTalkiePrototypeView', 'PTT'],
...
if '<string>0.10.8</string>' not in info or '<string>49</string>' not in info:
